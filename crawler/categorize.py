...
BENEFIT_KW = re.compile(
    ...
    r"|펫|반려|건강|헬스|블랙박스|설문|서베이|투데이|일상|주식|투자|증시|IPO"
)
...
# 수동 오버라이드 (키워드 규칙으로 잘못 분류되거나 미분류되는 경우만)
MANUAL: dict[str, str] = {
    # 안심/보안 - 키워드 미매칭 또는 오분류
    "인포세이프박스": "안심/보안",
    "T&캡스": "안심/보안",
    "더치트 프리미엄": "안심/보안",
    "원키퍼": "안심/보안",
